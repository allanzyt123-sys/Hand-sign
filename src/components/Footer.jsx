      ...
      <div className="footer-container">
        <div className="glass footer-content">
          <div className="footer-grid">
            <div>
              <h3 className="footer-heading gradient-text">
                SignBridge
              </h3>
              <p className="text-gray-600">
                Created with empathy, powered by AI.
              </p>
              <p className="text-gray-600 mt-2">
                Connecting the Silent World to the Sound of Understanding.
              </p>
            </div>
            <div>
              ...
              <ul className="footer-links">
                ...
                <li>
                  <Link to="/translator" className="footer-link">
                    Translator
                  </Link>
                </li>
                <li>
